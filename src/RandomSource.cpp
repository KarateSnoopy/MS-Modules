...
struct RandomSource : Module
{
    ...
    RandomSource() : Module(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS + 1)
    {
...
RandomSourceWidget::RandomSourceWidget()
{
    ...
    //Light
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(26, 156), module, RandomSource::SH_LIGHT));
};
