...
struct Mult : Module
{
    ...
    Mult() : Module(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS + 1) {}
    void step() override;
};
...
void Mult::step()
{
    ...
    lights[LIGHT1].value = IN_1 / 5.0;
    lights[LIGHT2].value = IN_2 / 5.0;
    lights[LIGHT3].value = IN_3 / 5.0;
};
...
MultWidget::MultWidget()
{
    ...
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(23, 19), module, Mult::LIGHT1));
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(63, 19), module, Mult::LIGHT2));
    addChild(createLight<SmallLight<GreenRedLight>>(Vec(103, 19), module, Mult::LIGHT3));
};
